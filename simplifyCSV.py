...
def importFiles():
	...
	dfPlayerSkaterRS = dd.read_csv(filepath + 'player_skater_stats_rs.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['PlayerId', 'TeamId', 'FranchiseId', 'GP', 'Goals', 'Assists', 'Plus_Minus', 'PIM', 'PP_Goals', 'PP_Assists', 'SH_Goals', 'SH_Assists', 'Fights', 'Fights_Won', 'Hits', 'GvA', 'TkA', 'SB', 'GR', 'Game_Rating_Off', 'Game_Rating_Def', 'SOG', 'TOI', 'PPTOI', 'SHTOI', 'PDO', 'GF_60', 'GA_60', 'SF_60', 'SA_60', 'CF', 'CA', 'CF_Per', 'CF_Per_Rel', 'FF', 'FA', 'FF_Per', 'FF_Per_Rel', 'GWG', 'FO', 'FOW'], dtype='string')
	...
	dfTeamData = dd.read_csv(filepath + 'team_data.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['TeamId', 'LeagueId', 'Team_Name', 'Team_Nickname', 'Abbr', 'Parent_Team1', 'Parent_Team2', 'Parent_Team3', 'Parent_Team4', 'Parent_Team5', 'Parent_Team6', 'Parent_Team7', 'Parent_Team8', 'Primary_Color', 'Secondary_Color', 'Text_Color', 'ConferenceId', 'DivisionId'], dtype='string')
	...
	dfPlayerGoalieRS = dd.read_csv(filepath + 'player_goalie_stats_rs.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0,names=['PlayerId', 'TeamId', 'FranchiseId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating'], usecols=['PlayerId', 'TeamId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating'], dtype='string')
	dfPlayerGoaliePO = dd.read_csv(filepath + 'player_goalie_stats_po.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0,names=['PlayerId', 'TeamId', 'FranchiseId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating'], usecols=['PlayerId', 'TeamId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating'], dtype='string')
	dfPlayerGoaliePS = dd.read_csv(filepath + 'player_goalie_stats_ps.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0,names=['PlayerId', 'TeamId', 'FranchiseId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating'], usecols=['PlayerId', 'TeamId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating'], dtype='string')	
	...
	dfTeamStats = dd.read_csv(filepath + 'team_stats.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['TeamId', 'GP', 'Goals', 'GA', 'Saves', 'SA', 'FO_Per', 'SB', 'Hits', 'TkA', 'GvA', 'InD', 'PIM_G', 'PP_Ch', 'PPG', 'SH_GA', 'SH_Ch', 'PP_GA', 'SHG', 'Att_Total_Home', 'Att_Total_Away', 'Att_Avg_Home', 'Att_Avg_Away', 'Sellouts_Home', 'Sellouts_Away', 'Capacity_Use_Per'], dtype='string')	
	dfTeamRecords = dd.read_csv(filepath + 'team_records.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['LeagueId', 'TeamId', 'ConfId', 'DivId', 'Wins', 'Losses', 'Ties', 'OTL', 'Shootout_Wins', 'Shootout_Losses', 'Points', 'Goals_For', 'Goals_Against', 'PCT'], dtype='string')	
	...
	dfBoxSkaterSummary = dd.read_csv(filepath + 'boxscore_skater_summary.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['GameId', 'PlayerId', 'TeamId', 'Game_Rating', 'Game_Rating_Off', 'Game_Rating_Def', 'Goals', 'Assists', 'Plus_Minus', 'SOG', 'MS', 'BS', 'PIM', 'Hits', 'TK', 'GV', 'SHF', 'TOT', 'PP', 'SH', 'EV', 'FOW', 'FOL', 'FO_Per', 'Team_Shots_on', 'Team_Shots_Against_on', 'Team_Shots_Missed_on', 'Team_Shots_Missed_Against_on', 'Team_Shots_Blocked_on', 'Team_Shots_Blocked_Against_on', 'Team_Goals_on', 'Team_Goal_Against_on', 'Team_Shots_off', 'Team_Shots_Against_off', 'Team_Shots_Missed_off', 'Team_Shots_Missed_Against_off', 'Team_Shots_Blocked_off', 'Team_Shots_Blocked_Against_off', 'Team_Goals_off', 'Team_Goal_Against_off', 'OZ_Starts', 'NZ_Starts', 'DZ_Starts', 'Team_OZ_Starts', 'Team_NZ_Starts', 'Team_DZ_Starts', 'SQ0', 'SQ1', 'SQ2', 'SQ3', 'SQ4'], dtype='string')	
	dfBoxGoalieSummary = dd.read_csv(filepath + 'boxscore_goalie_summary.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['GameId', 'PlayerId', 'TeamId', 'Game_Rating', 'SA', 'GA', 'SV', 'SV_Per', 'TOI', 'PIM'], dtype='string')	
	dfBoxGameSummary = dd.read_csv(filepath + 'boxscore_summary.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['GameId', 'Date_Year', 'Date_Month', 'Date_Day', 'Arena', 'Attendance', 'HomeId', 'AwayId', 'Score_Home', 'Score_Away', 'Score_Home_P1', 'Score_Home_P2', 'Score_Home_P3', 'Score_Home_OT', 'Score_Home_SO', 'Score_Away_P1', 'Score_Away_P2', 'Score_Away_P3', 'Score_Away_OT', 'Score_Away_SO', 'Star1', 'Star2', 'Star3', 'Shots_Home', 'Shots_Away', 'PIM_Home', 'PIM_Away', 'Hits_Home', 'Hits_Away', 'GA_Home', 'GA_Away', 'TA_Home', 'TA_Away', 'FOW_Home', 'FOW_Away', 'SOG_Home_P1', 'SOG_Home_P2', 'SOG_Home_P3', 'SOG_Home_OT', 'SOG_Away_P1', 'SOG_Away_P2', 'SOG_Away_P3', 'SOG_Away_OT', 'PPG_Home', 'PPO_Home', 'PPG_Away', 'PPO_Away', 'Type', 'SQ0_Home', 'SQ1_Home', 'SQ2_Home', 'SQ3_Home', 'SQ4_Home', 'SQ0_Away', 'SQ1_Away', 'SQ2_Away', 'SQ3_Away', 'SQ4_Away'], dtype='string')
	dfBoxScoringSummary = dd.read_csv(filepath + 'boxscore_period_scoring_summary.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['GameId', 'Period', 'Time', 'ScorerId', 'Assist1Id', 'Assist2Id', 'TeamId', 'Note', 'SQ'], dtype='string')
	dfBoxPenaltiesSummary = dd.read_csv(filepath + 'boxscore_period_penalties_summary.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['GameId', 'Period', 'Time', 'PlayerId', 'TeamId', 'Penalty', 'Minutes'], dtype='string')
	dfPlayerRatings = dd.read_csv(filepath + 'player_ratings.csv', blocksize=100e6, sep = ';', on_bad_lines='skip', encoding='ISO-8859-15', header=0, names=['PlayerId', 'Goalie', 'Left_D', 'Right_D', 'Left_W', 'Center', 'Right_W', 'Aggression', 'Bravery', 'Determination', 'Teamplayer', 'Leadership', 'Temperament', 'Professionalism', 'Mental_Toughness', 'Goalie_Stamina', 'Acceleration', 'Agility', 'Balance', 'Speed', 'Stamina', 'Strength', 'Fighting', 'Screening', 'Getting_Open', 'Passing', 'Puck_Handling', 'Shooting_Accuracy', 'Shooting_Range', 'Offensive_Read', 'Checking', 'Faceoffs', 'Hitting', 'Positioning', 'Shot_Blocking', 'Stick_Checking', 'Defensive_Read', 'Goalie_Positioning', 'Goalie_Passing', 'Goalie_Pokechecking', 'Goalie_Blocker', 'Goalie_Glove', 'Goalie_Rebound', 'Goalie_Recovery', 'Goalie_Puck_Handling', 'Goalie_Low_Shots', 'Goalie_Skating', 'Goalie_Reflexes', 'Skating', 'Shooting', 'Playmaking', 'Defending', 'Physicality', 'Conditioning', 'Player_Character', 'Hockey_Sense', 'Goalie_Technique', 'Goalie_Overall_Positioning', 'Ability', 'Potential'], dtype='string')
	...
	#staff_ratings.csv uses index_col=false because game file has ; at end of column headers on first line
...
def simplifyFiles(files, season, teams, leagues):
	...
	dfPlayerMaster = dfPlayerMaster.fillna(value = {'PlayerId': '-1', 'TeamId': '-1', 'Season': '-1', 'FranchiseId': '-1', 'First_Name': '-1', 'Last_Name': '-1', 'Nick_Name': 'None', 'Height': '-1', 'Weight': '-1', 'DOB': 'None', 'Birthcity': 'None', 'Birthstate': 'None', 'Nationality_One': 'None', 'Nationality_Two': 'None', 'Nationality_Three': 'None', 'Retired': '-1', 'Hand': 'None', 'Rookie': '-1'})
	...
	dfPlayerMaster = dfPlayerMaster.astype({'PlayerId': 'Int32', 'TeamId': 'Int32', 'Season': 'string', 'FranchiseId': 'Int32', 'First_Name': 'string', 'Last_Name': 'string', 'Nick_Name': 'string', 'Height': 'Int32', 'Weight': 'Int32', 'DOB': 'string', 'Birthcity': 'string', 'Birthstate': 'string', 'Nationality_One': 'string', 'Nationality_Two': 'string', 'Nationality_Three': 'string', 'Retired': 'Int32', 'Hand': 'string', 'Rookie': 'Int32'})

	dfPlayerRatings = dfPlayerRatings[dfPlayerRatings.count(axis='columns') == 60]
	dfPlayerRatings = dfPlayerRatings.astype({'PlayerId': 'Int32', 'Goalie': 'Int32', 'Left_D': 'Int32', 'Right_D': 'Int32', 'Left_W': 'Int32', 'Center': 'Int32', 'Right_W': 'Int32', 'Aggression': 'Int32', 'Bravery': 'Int32', 'Determination': 'Int32', 'Teamplayer': 'Int32', 'Leadership': 'Int32', 'Temperament': 'Int32', 'Professionalism': 'Int32', 'Mental_Toughness': 'Int32', 'Goalie_Stamina': 'Int32', 'Acceleration': 'Int32', 'Agility': 'Int32', 'Balance': 'Int32', 'Speed': 'Int32', 'Stamina': 'Int32', 'Strength': 'Int32', 'Fighting': 'Int32', 'Screening': 'Int32', 'Getting_Open': 'Int32', 'Passing': 'Int32', 'Shooting_Accuracy': 'Int32', 'Shooting_Range': 'Int32', 'Offensive_Read': 'Int32', 'Checking': 'Int32', 'Faceoffs': 'Int32', 'Hitting': 'Int32', 'Positioning': 'Int32', 'Shot_Blocking': 'Int32', 'Puck_Handling': 'Int32', 'Defensive_Read': 'Int32', 'Goalie_Positioning': 'Int32', 'Goalie_Passing': 'Int32', 'Goalie_Pokechecking': 'Int32', 'Goalie_Blocker': 'Int32', 'Goalie_Glove': 'Int32', 'Goalie_Rebound': 'Int32', 'Goalie_Recovery': 'Int32', 'Goalie_Puck_Handling': 'Int32', 'Goalie_Low_Shots': 'Int32', 'Goalie_Skating': 'Int32', 'Goalie_Reflexes': 'Int32', 'Skating': 'Int32', 'Shooting': 'Int32', 'Playmaking': 'Int32', 'Defending': 'Int32', 'Physicality': 'Int32', 'Conditioning': 'Int32', 'Player_Character': 'Int32', 'Hockey_Sense': 'Int32', 'Goalie_Technique': 'Int32', 'Goalie_Overall_Positioning': 'Int32', 'Ability': 'Float32', 'Potential': 'Float32'})

	dfPlayerMasterSimplified = dd.merge(dfPlayerMaster, dfPlayerRatings, on = 'PlayerId', how ='left')

	dfPlayerMasterSimplified = dfPlayerMasterSimplified[['PlayerId', 'TeamId', 'Season', 'FranchiseId', 'First_Name', 'Last_Name', 'Nick_Name', 'Height', 'Weight', 'DOB', 'Hand', 'Goalie', 'Left_D', 'Right_D', 'Center', 'Right_W', 'Aggression', 'Bravery', 'Determination', 'Teamplayer', 'Leadership', 'Temperament', 'Professionalism', 'Mental_Toughness', 'Acceleration', 'Agility', 'Balance', 'Speed', 'Stamina', 'Strength', 'Fighting', 'Screening', 'Getting_Open', 'Passing', 'Puck_Handling', 'Shooting_Accuracy', 'Shooting_Range', 'Offensive_Read', 'Checking', 'Faceoffs', 'Hitting', 'Positioning', 'Shot_Blocking', 'Stick_Checking', 'Defensive_Read', 'Skating', 'Shooting', 'Playmaking', 'Defending', 'Physicality', 'Conditioning', 'Player_Character', 'Hockey_Sense', 'Goalie_Technique', 'Goalie_Overall_Positioning', 'Goalie_Positioning', 'Goalie_Passing', 'Goalie_Pokechecking', 'Goalie_Blocker', 'Goalie_Glove', 'Goalie_Rebound', 'Goalie_Recovery', 'Goalie_Puck_Handling', 'Goalie_Low_Shots', 'Goalie_Skating', 'Goalie_Reflexes', 'Goalie_Stamina', 'Ability', 'Potential']]
	...
	dfPlayerSkaterRS = dfPlayerSkaterRS[dfPlayerSkaterRS.count(axis='columns') == 41]
	dfPlayerSkaterRS = dfPlayerSkaterRS[dfPlayerSkaterRS['TeamId'].isin(teams)]
	dfPlayerSkaterRS = dfPlayerSkaterRS.astype({'PlayerId': 'Int32', 'TeamId': 'Int32', 'FranchiseId': 'Int32', 'GP': 'Int32', 'Goals': 'Int32', 'Assists': 'Int32', 'Plus_Minus': 'Int32', 'PIM': 'Int32', 'PP_Goals': 'Int32', 'PP_Assists': 'Int32', 'SH_Goals': 'Int32', 'SH_Assists': 'Int32', 'Fights': 'Int32', 'Fights_Won': 'Int32', 'Hits': 'Int32', 'GvA': 'Int32', 'TkA': 'Int32', 'SB': 'Int32', 'GR': 'Int32', 'Game_Rating_Off': 'Int32', 'Game_Rating_Def': 'Int32', 'SOG': 'Int32', 'TOI': 'Int32', 'PPTOI': 'Int32', 'SHTOI': 'Int32', 'PDO': 'Float32', 'GF_60': 'Float32', 'GA_60': 'Float32', 'SF_60': 'Float32', 'SA_60': 'Float32', 'CF': 'Float32', 'CA': 'Float32', 'CF_Per': 'Float32', 'CF_Per_Rel': 'Float32', 'FF': 'Float32', 'FA': 'Float32', 'FF_Per': 'Float32', 'FF_Per_Rel': 'Float32', 'GWG': 'Int32', 'FO': 'Int32', 'FOW': 'Int32'})
	dfPlayerSkaterRS = dfPlayerSkaterRS[['PlayerId', 'TeamId', 'FranchiseId', 'GP', 'Goals', 'Assists', 'Plus_Minus', 'PIM', 'PP_Goals', 'PP_Assists', 'SH_Goals', 'SH_Assists', 'Fights', 'Fights_Won', 'Hits', 'GvA', 'TkA', 'SB', 'GR', 'Game_Rating_Off', 'Game_Rating_Def', 'SOG', 'TOI', 'PPTOI', 'SHTOI', 'PDO', 'GF_60', 'GA_60', 'SF_60', 'SA_60', 'CF', 'CA', 'CF_Per', 'CF_Per_Rel', 'FF', 'FA', 'FF_Per', 'FF_Per_Rel', 'GWG', 'FO', 'FOW']]
	...
	dfPlayerSkaterPO = dfPlayerSkaterPO[dfPlayerSkaterPO.count(axis='columns') == 41]
	dfPlayerSkaterPO = dfPlayerSkaterPO[dfPlayerSkaterPO['TeamId'].isin(teams)]
	dfPlayerSkaterPO = dfPlayerSkaterPO.astype({'PlayerId': 'Int32', 'TeamId': 'Int32', 'FranchiseId': 'Int32', 'GP': 'Int32', 'Goals': 'Int32', 'Assists': 'Int32', 'Plus_Minus': 'Int32', 'PIM': 'Int32', 'PP_Goals': 'Int32', 'PP_Assists': 'Int32', 'SH_Goals': 'Int32', 'SH_Assists': 'Int32', 'Fights': 'Int32', 'Fights_Won': 'Int32', 'Hits': 'Int32', 'GvA': 'Int32', 'TkA': 'Int32', 'SB': 'Int32', 'GR': 'Int32', 'Game_Rating_Off': 'Int32', 'Game_Rating_Def': 'Int32', 'SOG': 'Int32', 'TOI': 'Int32', 'PPTOI': 'Int32', 'SHTOI': 'Int32', 'PDO': 'Float32', 'GF_60': 'Float32', 'GA_60': 'Float32', 'SF_60': 'Float32', 'SA_60': 'Float32', 'CF': 'Float32', 'CA': 'Float32', 'CF_Per': 'Float32', 'CF_Per_Rel': 'Float32', 'FF': 'Float32', 'FA': 'Float32', 'FF_Per': 'Float32', 'FF_Per_Rel': 'Float32', 'GWG': 'Int32', 'FO': 'Int32', 'FOW': 'Int32'})
	dfPlayerSkaterPO = dfPlayerSkaterPO[['PlayerId', 'TeamId', 'FranchiseId', 'GP', 'Goals', 'Assists', 'Plus_Minus', 'PIM', 'PP_Goals', 'PP_Assists', 'SH_Goals', 'SH_Assists', 'Fights', 'Fights_Won', 'Hits', 'GvA', 'TkA', 'SB', 'GR', 'Game_Rating_Off', 'Game_Rating_Def', 'SOG', 'TOI', 'PPTOI', 'SHTOI', 'PDO', 'GF_60', 'GA_60', 'SF_60', 'SA_60', 'CF', 'CA', 'CF_Per', 'CF_Per_Rel', 'FF', 'FA', 'FF_Per', 'FF_Per_Rel', 'GWG', 'FO', 'FOW']]
	...
	dfPlayerSkaterPS = dfPlayerSkaterPS[dfPlayerSkaterPS.count(axis='columns') == 41]
	dfPlayerSkaterPS = dfPlayerSkaterPS[dfPlayerSkaterPS['TeamId'].isin(teams)]
	dfPlayerSkaterPS = dfPlayerSkaterPS.astype({'PlayerId': 'Int32', 'TeamId': 'Int32', 'FranchiseId': 'Int32', 'GP': 'Int32', 'Goals': 'Int32', 'Assists': 'Int32', 'Plus_Minus': 'Int32', 'PIM': 'Int32', 'PP_Goals': 'Int32', 'PP_Assists': 'Int32', 'SH_Goals': 'Int32', 'SH_Assists': 'Int32', 'Fights': 'Int32', 'Fights_Won': 'Int32', 'Hits': 'Int32', 'GvA': 'Int32', 'TkA': 'Int32', 'SB': 'Int32', 'GR': 'Int32', 'Game_Rating_Off': 'Int32', 'Game_Rating_Def': 'Int32', 'SOG': 'Int32', 'TOI': 'Int32', 'PPTOI': 'Int32', 'SHTOI': 'Int32', 'PDO': 'Float32', 'GF_60': 'Float32', 'GA_60': 'Float32', 'SF_60': 'Float32', 'SA_60': 'Float32', 'CF': 'Float32', 'CA': 'Float32', 'CF_Per': 'Float32', 'CF_Per_Rel': 'Float32', 'FF': 'Float32', 'FA': 'Float32', 'FF_Per': 'Float32', 'FF_Per_Rel': 'Float32', 'GWG': 'Int32', 'FO': 'Int32', 'FOW': 'Int32'})
	dfPlayerSkaterPS = dfPlayerSkaterPS[['PlayerId', 'TeamId', 'FranchiseId', 'GP', 'Goals', 'Assists', 'Plus_Minus', 'PIM', 'PP_Goals', 'PP_Assists', 'SH_Goals', 'SH_Assists', 'Fights', 'Fights_Won', 'Hits', 'GvA', 'TkA', 'SB', 'GR', 'Game_Rating_Off', 'Game_Rating_Def', 'SOG', 'TOI', 'PPTOI', 'SHTOI', 'PDO', 'GF_60', 'GA_60', 'SF_60', 'SA_60', 'CF', 'CA', 'CF_Per', 'CF_Per_Rel', 'FF', 'FA', 'FF_Per', 'FF_Per_Rel', 'GWG', 'FO', 'FOW']]
	...
	dfPlayerGoalieRS = dfPlayerGoalieRS.astype({'PlayerId': 'Int32', 'TeamId': 'Int32', 'Games_Played': 'Int32', 'Games_Started': 'Int32', 'Minutes_Played': 'Int32', 'Wins': 'Int32', 'Losses': 'Int32', 'OT': 'Int32', 'Shots_Against': 'Int32', 'Saves': 'Int32', 'Goals_Against': 'Int32', 'Goals_Against_Average': 'Float32', 'Shutouts': 'Int32', 'SV_Per': 'Float32', 'Game_Rating': 'Int32'})
	dfPlayerGoalieRS = dfPlayerGoalieRS[['PlayerId', 'TeamId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating']]
	...
	dfPlayerGoaliePO = dfPlayerGoaliePO.astype({'PlayerId': 'Int32', 'TeamId': 'Int32', 'Games_Played': 'Int32', 'Games_Started': 'Int32', 'Minutes_Played': 'Int32', 'Wins': 'Int32', 'Losses': 'Int32', 'OT': 'Int32', 'Shots_Against': 'Int32', 'Saves': 'Int32', 'Goals_Against': 'Int32', 'Goals_Against_Average': 'Float32', 'Shutouts': 'Int32', 'SV_Per': 'Float32', 'Game_Rating': 'Int32'})
	dfPlayerGoaliePO = dfPlayerGoaliePO[['PlayerId', 'TeamId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating']]
	...
	dfPlayerGoaliePS = dfPlayerGoaliePS.astype({'PlayerId': 'Int32', 'TeamId': 'Int32', 'Games_Played': 'Int32', 'Games_Started': 'Int32', 'Minutes_Played': 'Int32', 'Wins': 'Int32', 'Losses': 'Int32', 'OT': 'Int32', 'Shots_Against': 'Int32', 'Saves': 'Int32', 'Goals_Against': 'Int32', 'Goals_Against_Average': 'Float32', 'Shutouts': 'Int32', 'SV_Per': 'Float32', 'Game_Rating': 'Int32'})
	dfPlayerGoaliePS = dfPlayerGoaliePS[['PlayerId', 'TeamId', 'Games_Played', 'Games_Started', 'Minutes_Played', 'Wins', 'Losses', 'OT', 'Shots_Against', 'Saves', 'Goals_Against', 'Goals_Against_Average', 'Shutouts', 'SV_Per', 'Game_Rating']]
	...
	dfTeamData = dfTeamData.astype({'TeamId': 'Int32', 'LeagueId': 'Int32', 'Team_Name': 'string', 'Team_Nickname': 'string', 'Abbr': 'string', 'Parent_Team1': 'string', 'Parent_Team2': 'string', 'Parent_Team3': 'string', 'Parent_Team4': 'string', 'Parent_Team5': 'string', 'Parent_Team6': 'string', 'Parent_Team7': 'string', 'Parent_Team8': 'string', 'Primary_Color': 'string', 'Secondary_Color': 'string', 'Text_Color': 'string', 'ConferenceId': 'Int32', 'DivisionId': 'Int32'})
	dfTeamData = dfTeamData[['TeamId', 'LeagueId', 'Season', 'Team_Name', 'Team_Nickname', 'Abbr', 'Parent_Team1', 'Parent_Team2', 'Parent_Team3', 'Parent_Team4', 'Parent_Team5', 'Parent_Team6', 'Parent_Team7', 'Parent_Team8', 'Primary_Color', 'Secondary_Color', 'Text_Color', 'ConferenceId', 'DivisionId']]	
	...
	dfTeamStatsPlayoffs = dfTeamStatsPlayoffs.astype({'TeamId': 'Int32', 'GP': 'Int32', 'Goals': 'Int32', 'GA': 'Int32', 'Saves': 'Int32', 'SA': 'Int32', 'FO_Per': 'Float32', 'SB': 'Int32', 'Hits': 'Int32', 'TkA': 'Int32', 'GvA': 'Int32', 'InD': 'Int32', 'PIM_G': 'Float32', 'PP_Ch': 'Int32', 'PPG': 'Int32', 'SH_GA': 'Int32', 'SH_Ch': 'Int32', 'PP_GA': 'Int32', 'SHG': 'Int32', 'Att_Total_Home': 'Int32', 'Att_Total_Away': 'Int32', 'Att_Avg_Home': 'Int32', 'Att_Avg_Away': 'Int32', 'Sellouts_Home': 'Int32', 'Sellouts_Away': 'Int32', 'Capacity_Use_Per': 'Int32'})
	dfTeamStatsPlayoffs = dfTeamStatsPlayoffs.assign(Season=season)
	dfTeamStatsPlayoffs = dfTeamStatsPlayoffs[['TeamId', 'Season', 'GP', 'Goals', 'GA', 'Saves', 'SA', 'FO_Per', 'SB', 'Hits', 'TkA', 'GvA', 'InD', 'PIM_G', 'PP_Ch', 'PPG', 'SH_GA', 'SH_Ch', 'PP_GA', 'SHG', 'Att_Total_Home', 'Att_Total_Away', 'Att_Avg_Home', 'Att_Avg_Away', 'Sellouts_Home', 'Sellouts_Away', 'Capacity_Use_Per']]
	...
	dfTeamStats = dfTeamStats.astype({'TeamId': 'Int32', 'GP': 'Int32', 'Goals': 'Int32', 'GA': 'Int32', 'Saves': 'Int32', 'SA': 'Int32', 'FO_Per': 'Float32', 'SB': 'Int32', 'Hits': 'Int32', 'TkA': 'Int32', 'GvA': 'Int32', 'InD': 'Int32', 'PIM_G': 'Float32', 'PP_Ch': 'Int32', 'PPG': 'Int32', 'SH_GA': 'Int32', 'SH_Ch': 'Int32', 'PP_GA': 'Int32', 'SHG': 'Int32', 'Att_Total_Home': 'Int32', 'Att_Total_Away': 'Int32', 'Att_Avg_Home': 'Int32', 'Att_Avg_Away': 'Int32', 'Sellouts_Home': 'Int32', 'Sellouts_Away': 'Int32', 'Capacity_Use_Per': 'Int32'})
	...
	dfTeamRecords = dfTeamRecords.astype({'TeamId': 'Int32', 'Wins': 'Int32', 'Losses': 'Int32', 'Ties': 'Int32', 'OTL': 'Int32', 'Shootout_Wins': 'Int32', 'Shootout_Losses': 'Int32', 'Points': 'Int32', 'Goals_For': 'Int32', 'Goals_Against': 'Int32', 'PCT': 'Float32'})	
	dfTeamRecords = dfTeamRecords.assign(Season=season)

	dfTeamSimplified = dd.merge(dfTeamRecords, dfTeamStats, on = 'TeamId')

	dfTeamSimplified = dfTeamSimplified[['TeamId', 'Season', 'Wins', 'Losses', 'Ties', 'OTL', 'Shootout_Wins', 'Shootout_Losses', 'Points', 'Goals_For', 'Goals_Against', 'PCT', 'GP', 'Goals', 'GA', 'Saves', 'SA', 'FO_Per', 'SB', 'Hits', 'TkA', 'GvA', 'InD', 'PIM_G', 'PP_Ch', 'PPG', 'SH_GA', 'SH_Ch', 'PP_GA', 'SHG', 'Att_Total_Home', 'Att_Total_Away', 'Att_Avg_Home', 'Att_Avg_Away', 'Sellouts_Home', 'Sellouts_Away', 'Capacity_Use_Per']]
	...
	dfBoxGameSummary = dfBoxGameSummary.astype({'GameId': 'Int32', 'Arena': 'string', 'Attendance': 'Int32', 'Score_Home_P1': 'Int32', 'Score_Home_P2': 'Int32', 'Score_Home_P3': 'Int32', 'Score_Home_OT': 'Int32', 'Score_Home_SO': 'Int32', 'Score_Away_P1': 'Int32', 'Score_Away_P2': 'Int32', 'Score_Away_P3': 'Int32', 'Score_Away_OT': 'Int32', 'Score_Away_SO': 'Int32', 'Star1': 'Int32', 'Star2': 'Int32', 'Star3': 'Int32', 'Shots_Home': 'Int32', 'Shots_Away': 'Int32', 'PIM_Home': 'Int32', 'PIM_Away': 'Int32', 'Hits_Home': 'Int32', 'Hits_Away': 'Int32', 'GA_Home': 'Int32', 'GA_Away': 'Int32', 'TA_Home': 'Int32', 'TA_Away': 'Int32', 'FOW_Home': 'Int32', 'FOW_Away': 'Int32', 'SOG_Home_P1': 'Int32', 'SOG_Home_P2': 'Int32', 'SOG_Home_P3': 'Int32', 'SOG_Home_OT': 'Int32', 'SOG_Away_P1': 'Int32', 'SOG_Away_P2': 'Int32', 'SOG_Away_P3': 'Int32', 'SOG_Away_OT': 'Int32', 'PPG_Home': 'Int32', 'PPO_Home': 'Int32', 'PPG_Away': 'Int32', 'PPO_Away': 'Int32', 'SQ0_Home': 'Int32', 'SQ1_Home': 'Int32', 'SQ2_Home': 'Int32', 'SQ3_Home': 'Int32', 'SQ4_Home': 'Int32', 'SQ0_Away': 'Int32', 'SQ1_Away': 'Int32', 'SQ2_Away': 'Int32', 'SQ3_Away': 'Int32', 'SQ4_Away': 'Int32'})

	dfSchedulesGameSimplified = dd.merge(dfSchedules, dfBoxGameSummary, on = 'GameId')

	dfSchedulesGameSimplified = dfSchedulesGameSimplified[['LeagueId', 'Date', 'HomeId', 'Score_Home', 'AwayId', 'Score_Away', 'Type', 'Played', 'OT', 'SO', 'GameId', 'Arena', 'Attendance', 'Score_Home_P1', 'Score_Home_P2', 'Score_Home_P3', 'Score_Home_OT', 'Score_Home_SO', 'Score_Away_P1', 'Score_Away_P2', 'Score_Away_P3', 'Score_Away_OT', 'Score_Away_SO', 'Star1', 'Star2', 'Star3', 'Shots_Home', 'Shots_Away', 'PIM_Home', 'PIM_Away', 'Hits_Home', 'Hits_Away', 'GA_Home', 'GA_Away', 'TA_Home', 'TA_Away', 'FOW_Home', 'FOW_Away', 'SOG_Home_P1', 'SOG_Home_P2', 'SOG_Home_P3', 'SOG_Home_OT', 'SOG_Away_P1', 'SOG_Away_P2', 'SOG_Away_P3', 'SOG_Away_OT', 'PPG_Home', 'PPO_Home', 'PPG_Away', 'PPO_Away', 'SQ0_Home', 'SQ1_Home', 'SQ2_Home', 'SQ3_Home', 'SQ4_Home', 'SQ0_Away', 'SQ1_Away', 'SQ2_Away', 'SQ3_Away', 'SQ4_Away']]
	...
	dfBoxScoringSummary = dfBoxScoringSummary.astype({'GameId': 'Int32', 'Period': 'string', 'Time': 'Int32', 'ScorerId': 'Int32', 'Assist1Id': 'Int32', 'Assist2Id': 'Int32', 'TeamId': 'Int32', 'Note': 'string', 'SQ': 'Int32'})
	dfBoxScoringSummary = dfBoxScoringSummary[['GameId', 'Period', 'Time', 'ScorerId', 'Assist1Id', 'Assist2Id', 'TeamId', 'Note', 'SQ']]
	...
	dfBoxPenaltiesSummary = dfBoxPenaltiesSummary.astype({'GameId': 'Int32', 'Period': 'string', 'Time': 'Int32', 'PlayerId': 'Int32', 'TeamId': 'Int32', 'Penalty': 'string', 'Minutes': 'Int32'})
	dfBoxPenaltiesSummary = dfBoxPenaltiesSummary[['GameId', 'Period', 'Time', 'PlayerId', 'TeamId', 'Penalty', 'Minutes']]
	...
	dfBoxGoalieSummary = dfBoxGoalieSummary.astype({'GameId': 'Int32', 'PlayerId': 'Int32', 'TeamId': 'Int32', 'Game_Rating': 'Float32', 'SA': 'Int32', 'GA': 'Int32', 'SV': 'Int32', 'SV_Per': 'float32', 'TOI': 'Int32', 'PIM': 'Int32'})

	dfGameIdGoalie = dd.merge(dfSchedules, dfBoxGoalieSummary, on='GameId')
	...
	dfGameIdGoalie = dfGameIdGoalie[['LeagueId', 'Date', 'Type', 'GameId', 'PlayerId', 'TeamId', 'Game_Rating', 'SA', 'GA', 'SV', 'SV_Per', 'TOI', 'PIM']]
	...
	dfBoxSkaterSummary = dfBoxSkaterSummary.astype({'GameId': 'Int32', 'PlayerId': 'Int32', 'TeamId': 'Int32', 'Game_Rating': 'Float32', 'Game_Rating_Off': 'Float32', 'Game_Rating_Def': 'Float32', 'Goals': 'Int32', 'Assists': 'Int32', 'Plus_Minus': 'Int32', 'SOG': 'Int32', 'MS': 'Int32', 'BS': 'Int32', 'PIM': 'Int32', 'Hits': 'Int32', 'TK': 'Int32', 'GV': 'Int32', 'SHF': 'Int32', 'TOT': 'Int32', 'PP': 'Int32', 'SH': 'Int32', 'EV': 'Int32', 'FOW': 'Int32', 'FOL': 'Int32', 'FO_Per': 'Float32', 'Team_Shots_on': 'Int32', 'Team_Shots_Against_on': 'Int32', 'Team_Shots_Missed_on': 'Int32', 'Team_Shots_Missed_Against_on': 'Int32', 'Team_Shots_Blocked_on': 'Int32', 'Team_Shots_Blocked_Against_on': 'Int32', 'Team_Goals_on': 'Int32', 'Team_Goal_Against_on': 'Int32', 'Team_Shots_off': 'Int32', 'Team_Shots_Against_off': 'Int32', 'Team_Shots_Missed_off': 'Int32', 'Team_Shots_Missed_Against_off': 'Int32', 'Team_Shots_Blocked_off': 'Int32', 'Team_Shots_Blocked_Against_off': 'Int32', 'Team_Goals_off': 'Int32', 'Team_Goal_Against_off': 'Int32', 'OZ_Starts': 'Int32', 'NZ_Starts': 'Int32', 'DZ_Starts': 'Int32', 'Team_OZ_Starts': 'Int32', 'Team_NZ_Starts': 'Int32', 'Team_DZ_Starts': 'Int32', 'SQ0': 'Int32', 'SQ1': 'Int32', 'SQ2': 'Int32', 'SQ3': 'Int32', 'SQ4': 'Int32'})

	dfGameIdPlayer = dd.merge(dfSchedules, dfBoxSkaterSummary, on='GameId')
	...
	dfGameIdPlayer = dfGameIdPlayer[['LeagueId', 'Date', 'Type', 'GameId', 'PlayerId', 'TeamId', 'Game_Rating', 'Game_Rating_Off', 'Game_Rating_Def', 'Goals', 'Assists', 'Plus_Minus', 'SOG', 'MS', 'BS', 'PIM', 'Hits', 'TK', 'GV', 'SHF', 'TOT', 'PP', 'SH', 'EV', 'FOW', 'FOL', 'FO_Per', 'Team_Shots_on', 'Team_Shots_Against_on', 'Team_Shots_Missed_on', 'Team_Shots_Missed_Against_on', 'Team_Shots_Blocked_on', 'Team_Shots_Blocked_Against_on', 'Team_Goals_on', 'Team_Goal_Against_on', 'Team_Shots_off', 'Team_Shots_Against_off', 'Team_Shots_Missed_off', 'Team_Shots_Missed_Against_off', 'Team_Shots_Blocked_off', 'Team_Shots_Blocked_Against_off', 'Team_Goals_off', 'Team_Goal_Against_off', 'OZ_Starts', 'NZ_Starts', 'DZ_Starts', 'Team_OZ_Starts', 'Team_NZ_Starts', 'Team_DZ_Starts', 'SQ0', 'SQ1', 'SQ2', 'SQ3', 'SQ4']]
	...
	#Check staff_master.csv for null values and fill the correct value in for each column. Check staff_ratings.csv for null values and fill the correct value in for each column. Then drop StaffId with '-1' values as they are either duplicates or not needed. Set data type for both, merge into one dataframe, order columns and then export to staff file. 
	dfStaffMaster = dfStaffMaster.fillna(value = {'StaffId': '-1', 'TeamId': '-1', 'Season': '-1', 'FranchiseId': '-1', 'First_Name': '-1', 'Last_Name': '-1', 'Nick_Name': 'None', 'DOB': 'None', 'Birthcity': 'None', 'Birthstate': 'None', 'Nationality_One': 'None', 'Nationality_Two': 'None', 'Nationality_Three': 'None', 'Retired': '-1'})
	...
	dfStaffRatings = dfStaffRatings.fillna(value = {'StaffId': '0', 'Executive': '0', 'Manager': '0', 'Coach': '0', 'Scout': '0', 'Trainer': '0', 'Off_Pref': 'Defensive', 'Phy_Pref': 'Non-Physical', 'Line_Matching': 'Balanced', 'Goalie_Handling': 'Balanced', 'Favor_Veterans': 'Balanced', 'Innovation': 'Balanced', 'Loyalty': 'Balanced', 'Coaching_G': '0', 'Coaching_Defense': '0', 'Coaching_Forwards': '0', 'Coaching_Prospects': '0', 'Def_Skills': '0', 'Off_Skills': '0', 'Phy_Training': '0', 'Player_Management': '0', 'Motivation': '0', 'Discipline': '0', 'Negotiating': '0', 'Self-Preservation': '0', 'Tactics': '0', 'Ingame_Tactics': '0', 'Trainer_Skill': '0', 'Evaluate_Abilities': '0', 'Evaluate_Potential': '0'})
	...
	dfDraft = dd.merge(dfDraftResult, dfDraftInfo, on = 'DraftId')
